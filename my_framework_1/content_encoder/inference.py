...
parser.add_argument('--model_path', type=str, default='result/best_model.pt')

parser.add_argument('--output_path', type=str, default='result/predict.json')
args = parser.parse_args()

if __name__ == '__main__':
    model = get_model(args.model_name, input_ndim=28*12, output_ndim=136)
