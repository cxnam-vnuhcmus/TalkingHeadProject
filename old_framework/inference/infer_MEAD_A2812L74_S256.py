...
parser.add_argument('--config_file', type=str, default='/root/TalkingHead/config/config_MEAD_A2812L74_S256.yaml')
parser.add_argument('--mfcc_folder', type=str, default='/root/Datasets/Features/M003/mfccs/neutral/level_1/00001')
...
if __name__ == '__main__': 
    ...
    print(f"Image path: {mfcc_path.replace('mfccs', 'images')}")
    ...
    if config['export_vid2vid']:
        ...
        img_path = mfcc_path.replace('mfccs','images')
