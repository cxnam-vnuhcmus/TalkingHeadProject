...
parser.add_argument("--landmark_folder", type=str, default='landmarks74')
parser.add_argument("--image_folder", type=str, default='images')
parser.add_argument("--mead_feature_folder", type=str, default='/root/Datasets/CREMA-D/Features')
parser.add_argument("--imaginaire_folder", type=str, default='/root/TalkingHeadProject/imaginaire/datasets512')
...
#     total_list = []
#     lm_folder = join(args.mead_feature_folder, args.landmark_folder)
#     for seq in os.listdir(lm_folder):
#         lm_seq_folder = join(lm_folder, seq)
#         total_list.append(lm_seq_folder)
...
#     json_list = sorted(glob(join(folder, '**/*.json'), recursive=True))
#     for json_file in tqdm(json_list, 'LM68: '):
#         with open(json_file, 'r') as f:
#             data = json.load(f)
#             data = [[x + data['bb'][0], y + data['bb'][1]] for (x,y) in data['lm68']]
#         with open(json_file, 'w') as f:
#             json.dump(data, f)

# get_landmark68('/root/TalkingHeadProject/imaginaire/datasets512/train/landmarks-dlib68')
# get_landmark68('/root/TalkingHeadProject/imaginaire/datasets512/val/landmarks-dlib68')

# def check_lm_img(folder):
#     json_list = sorted(glob(join(folder, '**/*.json'), recursive=True))
#     for json_file in tqdm(json_list, 'LM68: '):
#         img_file = json_file.replace('landmarks-dlib68', 'images')
